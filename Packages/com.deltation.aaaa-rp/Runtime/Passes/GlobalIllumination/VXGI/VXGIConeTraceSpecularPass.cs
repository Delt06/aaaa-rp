...
{
    public class VXGIConeTraceSpecularPass : AAAARasterRenderPass<VXGIConeTraceSpecularPass.PassData>, IDisposable
    {
        private const int PassIndex = 1;
        private readonly Material _gatherMaterial;
        private readonly Material _material;

        public VXGIConeTraceSpecularPass(AAAARenderPassEvent renderPassEvent) : base(renderPassEvent)
        {
        ...
        public override string Name => "VXGI.ConeTrace.Specular";
