...
#ifndef AAAA_UNITY_INPUT_INCLUDED
#define AAAA_UNITY_INPUT_INCLUDED
// Unity Engine built-in shader input variables.
// AAAARP package specific shader input variables are defined in ShaderLibrary/Input.hlsl
