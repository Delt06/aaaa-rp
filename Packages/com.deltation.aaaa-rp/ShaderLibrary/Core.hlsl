#ifndef AAAA_CORE_INCLUDED
#define AAAA_CORE_INCLUDED

// VT is not supported in AAAARP (for now) this ensures any shaders using the VT
...
#include "Packages/com.deltation.aaaa-rp/ShaderLibrary/Input.hlsl"
